...
const UserFindPW = () => {
  ...
  const handleSubmit = e => {
    e.preventDefault();
  axios.get(`http://13.125.133.39:8080/H2O/user/findPw?userId=${userId}&name=${userName}&phone=${phoneNumber}`)
    .then(response => {
      alert('성공')
  ...
  const handleSaveNewPassword = e => {
    ...
    if( newPassword === confirmNewPassword ) {
      axios.patch(`http://13.125.133.39:8080/H2O/user/${userNo}`, {password: newPassword})
        .then( () => {
