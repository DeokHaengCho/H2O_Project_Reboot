...
const UserAdd = () => {
  ...
  const handleIdCheck = e =>   {
    ...
    e.preventDefault();
    axios
      .get(`http://13.125.133.39:8080/H2O/hospital/BusinessLicenseCheck/${businessLicenseNumber}`)
      .then(response => {
        alert("이미 등록된 병원입니다.");
  ...
  const handleSubmit = e => {
    ...
    if(hospitalIdChecker==="available"){
      axios.post(`http://13.125.133.39:8080/H2O/hospital/hospitalAdd`, userJson)
        .then(response => {
          alert("병원 등록 성공 !")
